...
const render=data=>{
  ...
  const rewrite=data.is_rewrite?'<div class="alert alert-info"><strong>Súmula já importada.</strong> Ao confirmar, os dados anteriores desta partida serão substituídos.</div>':'';
