...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 if(adminVersions.length&&adminVersions[0][0]!=='a2.7')adminVersions.unshift(['a2.7','Logos, taças e imagens de títulos históricos ganharam editor visual com arraste, posição e zoom antes do salvamento.']);
