...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 const releaseKey=`vascao-release-seen-${releaseVersion}`;
 document.body.insertAdjacentHTML('beforeend',`<div class="modal fade release-notes-modal" id="release-notes-modal" tabindex="-1" aria-labelledby="release-notes-title" aria-hidden="true"><div class="modal-dialog modal-fullscreen-md-down modal-xl modal-dialog-centered modal-dialog-scrollable"><div class="modal-content"><div class="release-notes-hero"><div><span class="release-notes-kicker">NOVA ATUALIZAÇÃO</span><h2 id="release-notes-title">O JOGO FICOU <em>MAIS COMPLETO.</em></h2><p>A v${releaseVersion} reúne as novidades que chegaram desde a última versão em produção.</p></div><div class="release-version-stamp"><small>PATCH</small><strong>${releaseVersion}</strong></div><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Fechar novidades"></button></div><div class="modal-body"><div class="release-feature-grid"><article><span>01</span><div><h3>Dois rankings de jogadores</h3><p>Alterne entre Artilheiros e Assistências, navegue com a paginação compacta e clique em qualquer jogador para abrir seus números.</p></div></article><article><span>02</span><div><h3>Histórico mais inteligente</h3><p>Participações agora têm paginação, notas por desempenho e uma linha do tempo com gols, VAR, substituições, cartões e lesões.</p></div></article><article><span>03</span><div><h3>Times com mais identidade</h3><p>O Herói do Time exibe overall, posição, gols e assistências. Os destaques levam direto ao histórico individual.</p></div></article><article><span>04</span><div><h3>Confrontos diretos</h3><p>O duelo entre rivais ficou mais claro e abre o histórico completo dos jogos, com acesso rápido às súmulas e aos detalhes do placar.</p></div></article><article><span>05</span><div><h3>Campeonato certo na abertura</h3><p>O site prioriza a competição que já possui partidas disputadas. Campeonatos apenas cadastrados ficam disponíveis sem tomar o lugar do torneio em andamento.</p></div></article><article><span>06</span><div><h3>Partidas sem interrupções</h3><p>Súmulas são priorizadas, condições aparecem de forma organizada e os detalhes abrem sem loading ou piscadas.</p></div></article></div></div><div class="modal-footer"><p>Explore os times, jogadores e confrontos para ver tudo em ação.</p><button type="button" class="btn btn-danger release-notes-continue" data-bs-dismiss="modal">CONHECER A ATUALIZAÇÃO</button></div></div></div></div>`);
 const releaseModal=document.getElementById('release-notes-modal');
 releaseModal.addEventListener('shown.bs.modal',()=>{try{localStorage.setItem(releaseKey,'1')}catch(error){}});
 let releaseSeen=false;try{releaseSeen=localStorage.getItem(releaseKey)==='1'}catch(error){}
 if(!releaseSeen)window.addEventListener('load',()=>setTimeout(()=>bootstrap.Modal.getOrCreateInstance(releaseModal).show(),450),{once:true});
});
