...
<head>
  ...
  <link rel="stylesheet" href="assets/css/style.css"><link rel="stylesheet" href="assets/css/branding.css?v=5">
...
<body>
<nav class="navbar navbar-expand-lg fixed-top navbar-dark"><div class="container"><a class="navbar-brand d-flex align-items-center gap-2" href="index.php"><img class="brand-mark" src="assets/img/logo-season3.webp?v=5" alt="Vascao Season 3"><span>VASCÃO <b>S3</b></span></a><button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#commands-menu"><span class="navbar-toggler-icon"></span></button><div id="commands-menu" class="collapse navbar-collapse"><ul class="navbar-nav ms-auto align-items-lg-center"><li class="nav-item"><a class="nav-link" href="index.php#competicao">Competição</a></li><li class="nav-item"><a class="nav-link" href="index.php#participantes">Participantes</a></li><li class="nav-item"><a class="nav-link" href="index.php#artilharia">Artilharia</a></li><li class="nav-item"><a class="nav-link" href="index.php#titulos">Títulos</a></li><li class="nav-item"><a class="nav-link active" href="comandos.php">Comandos</a></li><li class="nav-item"><a class="nav-link" href="regulamento.php">Regulamento</a></li><li class="nav-item"><a class="nav-link" href="noticias.php">Notícias</a></li><li class="nav-item ms-lg-2"><?php if (
    account_logged_in() &&
    account_is_admin()
...
<main class="commands-page section-pad"><div class="container"><span class="eyebrow">Guia DreamTeam</span><div class="section-title mt-4 mb-3"><span>/</span><div><small>CONSULTA RÁPIDA</small><h2>COMANDOS</h2></div></div><p class="commands-intro mb-4">Encontre rapidamente o comando necessário para gerenciar seu clube, elenco, mercado e partidas.</p><div class="command-search mb-2"><span>/</span><input id="command-search" type="search" placeholder="Busque por /time, mercado, carreira..." autocomplete="off" autofocus></div><p id="commands-count" class="commands-count mb-4"></p><div class="row g-3" id="commands-grid"></div><div id="commands-empty" class="public-empty d-none"><img class="empty-season-logo" src="assets/img/logo-season3.webp?v=5" alt=""><p>Nenhum comando corresponde à sua busca.</p></div></div></main>
