...
$pairJson=[];foreach($pairs as $pair){$pairJson[$pair['a_id'].':'.$pair['b_id']]=$pair;$pairJson[$pair['b_id'].':'.$pair['a_id']]=['a_id'=>$pair['b_id'],'b_id'=>$pair['a_id'],'a'=>$pair['b'],'b'=>$pair['a'],'games'=>$pair['games'],'a_wins'=>$pair['b_wins'],'b_wins'=>$pair['a_wins'],'draws'=>$pair['draws'],'a_goals'=>$pair['b_goals'],'b_goals'=>$pair['a_goals'],'matches'=>$pair['matches']];}
