...
<body class="d-flex align-items-center min-vh-100 py-5"><main class="container" style="max-width:520px"><a class="text-secondary text-decoration-none" href="index.php">← Voltar ao site</a><div class="panel p-4 mt-3"><span class="eyebrow">Vascão Season 3</span><h1 class="font-condensed mt-3">CRIAR CONTA</h1><p class="text-secondary">Crie seu acesso. A associação ao seu time será feita pela administração depois da conferência.</p><?php if (
    $error
