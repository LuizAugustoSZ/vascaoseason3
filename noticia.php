...
<body>
    ...
    <main class="news-page">
        <article class="container article-shell"><a class="text-secondary text-decoration-none" href="noticias.php">← Voltar ao jornal</a><span class="eyebrow d-block mt-4">Notícias do servidor</span>
