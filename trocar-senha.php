...
<body class="d-flex align-items-center min-vh-100"><main class="container" style="max-width:520px"><div class="panel p-4"><span class="eyebrow"><?= $obrigatoria
    ...
    ? "admin/"
    : "index.php" ?>">Cancelar</a><?php endif; ?><a class="btn btn-link text-secondary w-100" href="logout.php">Sair da conta</a></div></main></body></html>
