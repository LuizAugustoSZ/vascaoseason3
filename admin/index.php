...
.master-role>.navbar,.editor-role>.navbar{left:264px;transition:left .22s ease}@media(min-width:768px){.admin-nav-collapsed>.navbar{left:68px}}@media(max-width:767.98px){.master-role>.navbar,.editor-role>.navbar{left:0}}
</style>
