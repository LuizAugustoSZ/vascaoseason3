...
<nav class="navbar fixed-top navbar-dark"><div class="container-fluid px-3 px-lg-4"><a class="navbar-brand" href="../index.php"><img class="brand-mark d-inline-block me-2" src="../assets/img/logo-season3.webp?v=5" alt="Vascao Season 3"> PAINEL S3</a><div class="global-nav-links" aria-label="Seções públicas"><a href="../index.php#competicao">Competição</a><a href="../index.php#artilharia">Jogadores</a><a href="../index.php#participantes">Participantes</a><a href="../titulos.php">Títulos</a><a href="../index.php#midia">Vídeos</a></div><div class="d-flex align-items-center gap-3"><span class="text-secondary d-none d-md-inline">Olá, <?= e($_SESSION["conta_nome"] ?? "") ?></span><button type="button" class="btn btn-outline-light btn-sm admin-menu-toggle" aria-label="Recolher ou abrir menu do painel" aria-expanded="true">☰ Menu</button></div></div></nav>
