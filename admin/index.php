...
<ul class="nav nav-pills gap-2 mb-4"><li><button class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab-jogos">Pontos corridos</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-mata">Mata-mata</button></li><?php if (
    account_is_master()
