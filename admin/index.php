...
<!doctype html><html lang="pt-BR" data-bs-theme="dark"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Painel | Season 3</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="../assets/css/style.css"><link rel="stylesheet" href="../assets/css/branding.css?v=5"><link rel="stylesheet" href="../assets/css/news.css?v=<?= filemtime(
    ...
    ? "editor-role"
    : "master-role" ?>">
<style>.admin-navigation{padding:1rem;border:1px solid #292d35;border-radius:16px;background:#111318}.admin-menu-groups{display:flex;gap:.5rem;overflow-x:auto;padding-bottom:.75rem;border-bottom:1px solid #292d35}.admin-menu-group{flex:0 0 auto;border:0;background:transparent;color:#9299a5;padding:.55rem .85rem;border-radius:9px;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.admin-menu-group:hover,.admin-menu-group.active{background:#252932;color:#fff}.admin-submenu{display:none;gap:.5rem;flex-wrap:wrap;padding-top:.75rem}.admin-submenu.active{display:flex}.admin-submenu .nav-link{display:inline-flex;align-items:center;border:1px solid #343941;color:#d8dce3;background:#0b0c0e;border-radius:9px;padding:.5rem .8rem;text-decoration:none}.admin-submenu .nav-link:hover{border-color:#d71920;color:#fff}.admin-submenu .nav-link.active{border-color:#d71920;background:#d71920;color:#fff}.admin-embedded-frame{display:block;width:100%;min-height:1100px;border:0;background:#08090b}@media(max-width:767.98px){.admin-heading{align-items:stretch!important}.admin-heading h1{font-size:2.5rem}.admin-submenu{flex-wrap:nowrap;overflow-x:auto}.admin-submenu>*{flex:0 0 auto}.admin-embedded-frame{min-height:1500px}}</style>
