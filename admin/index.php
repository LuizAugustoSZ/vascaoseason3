...
<!doctype html><html lang="pt-BR" data-bs-theme="dark"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Painel | Season 3</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="../assets/css/style.css"><link rel="stylesheet" href="../assets/css/branding.css?v=5"><link rel="stylesheet" href="../assets/css/news.css?v=<?= filemtime(
    ...
    ? "editor-role"
    : "master-role" ?>">
<style>.admin-navigation{padding:1rem;border:1px solid #292d35;border-radius:16px;background:#111318}.admin-menu-groups{display:flex;gap:.5rem;overflow-x:auto;padding-bottom:.75rem;border-bottom:1px solid #292d35}.admin-menu-group{flex:0 0 auto;border:0;background:transparent;color:#9299a5;padding:.55rem .85rem;border-radius:9px;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.admin-menu-group:hover,.admin-menu-group.active{background:#252932;color:#fff}.admin-submenu{display:none;gap:.5rem;flex-wrap:wrap;padding-top:.75rem}.admin-submenu.active{display:flex}.admin-submenu .nav-link,.admin-submenu .admin-nav-link{display:inline-flex;align-items:center;border:1px solid #343941;color:#d8dce3;background:#0b0c0e;border-radius:9px;padding:.5rem .8rem;text-decoration:none}.admin-submenu .nav-link:hover,.admin-submenu .admin-nav-link:hover{border-color:#d71920;color:#fff}.admin-submenu .nav-link.active{border-color:#d71920;background:#d71920;color:#fff}@media(max-width:767.98px){.admin-heading{align-items:stretch!important}.admin-heading h1{font-size:2.5rem}.admin-submenu{flex-wrap:nowrap;overflow-x:auto}.admin-submenu>*{flex:0 0 auto}}</style>
...
<nav class="admin-navigation mb-4" aria-label="Navegação administrativa"><div class="admin-menu-groups" role="tablist" aria-label="Categorias do painel"><?php if (account_is_master()): ?><button type="button" class="admin-menu-group" data-admin-group="overview">Visão geral</button><?php endif; ?><button type="button" class="admin-menu-group active" data-admin-group="competition">Competição</button><?php if (account_is_master()): ?><button type="button" class="admin-menu-group" data-admin-group="people">Pessoas &amp; clubes</button><?php endif; ?><button type="button" class="admin-menu-group" data-admin-group="content">Conteúdo &amp; site</button></div><?php if (account_is_master()): ?><div class="admin-submenu" data-admin-submenu="overview"><a class="admin-nav-link" href="dashboard.php"><span aria-hidden="true" class="me-2">▦</span>Dashboard</a></div><?php endif; ?><ul class="nav nav-pills admin-submenu active" data-admin-submenu="competition"><li><button class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab-jogos">Pontos corridos</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-mata">Mata-mata</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-sumula">Importar súmula</button></li><?php if (
    account_is_master()
): ?><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-campeonatos">Campeonatos</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-supercopa">Supercopa</button></li><?php endif; ?><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-extra">Artilharia</button></li><?php if (account_is_master()): ?><li><a class="admin-nav-link" href="sorteador.php">Sorteador</a></li><?php endif; ?></ul><?php if (account_is_master()): ?><ul class="nav nav-pills admin-submenu" data-admin-submenu="people"><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-times">Técnicos e times</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-usuarios">Usuários</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-mercado">Mercado</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-titulos">Títulos</button></li></ul><?php endif; ?><ul class="nav nav-pills admin-submenu" data-admin-submenu="content"><?php if (
    account_is_master()
): ?><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-videos">Vídeos</button></li><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-configuracoes">Configurações</button></li><?php endif; ?><li><button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-noticias">Notícias</button></li><li><a class="admin-nav-link" href="../index.php" target="_blank" rel="noopener">Abrir site</a></li></ul></nav>
