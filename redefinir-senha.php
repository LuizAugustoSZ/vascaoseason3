...
<?php if ($success): ?><div class="alert alert-success" data-flash-toast>Senha alterada com sucesso. Agora você já pode entrar.</div><a class="btn btn-danger w-100" href="login.php">Entrar</a>
