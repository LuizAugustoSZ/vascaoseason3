...
<body>
    ...
    <main class="news-page">
        <div class="container"><span class="eyebrow">Notícias do servidor</span>
            <div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-4">
                <h1 class="display-3 fw-bold mb-0">JORNAL DO VASCÃO</h1><span class="text-secondary"><?= $total ?> <?= $total ===
                                                                                                                        1
                                                                                                                        ? "postagem"
                                                                                                                        : "postagens" ?></span>
            </div>
            <div class="row g-4"><?php
                        ...
                        <article class="news-card"><a href="noticia.php?id=<?= $item["id"] ?>"><img src="<?= e(
                            ...
                            <div class="news-card-body"><span class="news-meta"><?= e(
                                ...
                                <h2 class="mt-2"><a class="text-white text-decoration-none" href="noticia.php?id=<?= $item["id"] ?>"><?= e($item["titulo"]) ?></a></h2><?php if ($item["resumo"]): ?><p><?= e(
                                                                                $item["resumo"],
            ...
            $pages > 1
                                                                ...
                                                                $i++
                                                                    ...
                                                                    ? "btn-danger"
                                                                    : "btn-outline-light" ?>" href="?pagina=<?= $i ?>"><?= $i ?></a><?php endfor; ?></div><?php endif; ?>
        </div>
