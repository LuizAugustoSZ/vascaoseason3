...
<header id="inicio" class="hero d-flex align-items-center">
  ...
  <div class="container position-relative py-5">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-5"><div id="hero-feature-carousel" class="carousel slide hero-feature-carousel" data-bs-ride="carousel" data-bs-interval="7000" data-bs-pause="hover"><div class="carousel-indicators"><?php
...
0
    ...
    : "" ?>" aria-label="Destaque <?= $heroSlide + 1 ?>"></button><?php endfor;
      ?></div><div class="carousel-inner"><?php
$heroFirst = true;
if (
    $heroVideoId !== ""
): ?><div class="carousel-item active" data-feature-type="video"><div id="hero-video-shell" class="hero-video-shell"><button id="hero-video-close" class="hero-video-close" type="button" aria-label="Fechar vídeo flutuante">×</button><div id="hero-latest-video" data-video-id="<?= e(
    $heroVideoId,
) ?>"></div></div><div class="hero-feature-caption"><small>ÚLTIMO VÍDEO</small><strong><?= e(
    $latestVideo["titulo"],
) ?></strong></div></div><?php $heroFirst = false;endif;
foreach ($latestNews as $heroNews): ?><div class="carousel-item <?= $heroFirst
    ? "active"
    : "" ?>" data-feature-type="news"><a class="hero-news-slide" href="noticia.php?id=<?= $heroNews[
    "id"
] ?>"><img src="<?= e(
    $heroNews["capa_base64"],
) ?>" alt=""><span class="hero-news-overlay"></span><div class="hero-feature-caption"><small>ÚLTIMA NOTÍCIA</small><strong><?= e(
    $heroNews["titulo"],
) ?></strong><span>Ler matéria →</span></div></a></div><?php $heroFirst = false;endforeach;
if (
    $heroFirst
): ?><div class="carousel-item active"><div class="hero-feature-empty"><img class="empty-season-logo" src="assets/img/logo-season3.webp?v=5" alt=""><p>Novos vídeos e notícias aparecerão aqui.</p></div></div><?php endif;
?></div><?php if (
    $heroSlideCount > 1
...
) ?></span><h3 class="mt-2"><a class="text-white text-decoration-none" href="noticia.php?id=<?= $item[
    "id"
] ?>"><?= e($item["titulo"]) ?></a></h3><?php if ($item["resumo"]): ?><p><?= e(
    $item["resumo"],
